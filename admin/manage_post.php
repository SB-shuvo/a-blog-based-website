			...
			<form action="" id="manage-category">
				...
				<div class="form-group">
					<label for="" class="control-label">Add Image to Content</label>
						...
						<video width="320" height="240" controls><source src="../assets/img/<?php echo isset($meta['img_path']) ? $meta['img_path'] : '' ?>" alt="" class="img-field" type="video/mp4"></video>
						<br>
							<div class="input-group mb-3 col-md-3">
							  ...
							  <div class="custom-file">
							    <input type="file" name="img" class="custom-file-input" id="img" aria-describedby="" accept="mp4/*" onchange="displayImg(this,$(this))">
